...
import modalAgregarUsuarioCajero from '~/components/cajero/usuarios/modalAgregarUsuarioCajero.vue'
import modalModificarUsuarioCajero from '~/components/cajero/usuarios/modalModificarUsuarioCajero.vue'
...
async function obtenerUsuarios() {
  try {
    ...
    Usuarios.value = res.filter(item => item.rol === "cliente")
  } catch (err) {
    console.error(err)
  }
}
